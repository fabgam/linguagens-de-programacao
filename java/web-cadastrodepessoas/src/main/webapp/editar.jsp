    ...
    <body> 
        ...
        <div class="container container-fluid">
            <div class="page-header">
                <h3>Edição de dados cadastrais</h3>
            </div>
            <form action="editcadastro" method="post">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group form-group-sm col-md-12">
                        ...
                        <input type="text" class="form-control " value="${requestScope.nome}" id="nome" name="nome">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group form-group-sm col-md-12">
                        <label for="cpf">CPF *</label>
                        <input type="text" class="form-control" value="${requestScope.cpf}" id="cpf" name="cpf">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group form-group-sm col-md-12">
                        <label for="rg">RG *</label>
                        <input type="text" class="form-control" value="${requestScope.rg}" id="rg" name="rg">
                        <sub>* Campos de preenchimento obrigatório</sub>                                    
                    </div>
                </div>   
                <div class="row">
                    <div class="col-md-12">                        
                        <button type="submit" class="btn btn-primary btn-block" name="action" value="editar">Salvar</button>
                        <button type="submit" class="btn btn-default btn-block" name="action" value="redirecionaExibir">Cancelar</button>
                    </div>
                </div>
            </form>
        </div>
